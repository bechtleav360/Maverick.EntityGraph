package cougar.graph.model.enums;
...
public class RdfMimeTypes extends MediaType {
    ...
    public static final String RDFXML_VALUE = "application/cougar.graph.model.rdf+xml";
    public static final String RDFJSON_VALUE = "application/cougar.graph.model.rdf+json";
    ...
    public static final String BINARY_VALUE= "application/x-binary-cougar.graph.model.rdf";
