...
public class ScopedQueries extends AbstractController {
    ...
    @PostMapping(value = "/sc/{scope}/query/select", consumes = "text/plain", produces = {"text/csv", "application/sparql-results+json"})
    ...
    @PostMapping(value = "/sc/{scope}/query/construct", consumes = "text/plain", produces = {"text/turtle", "application/ld+json"})
    @ResponseStatus(HttpStatus.ACCEPTED)
