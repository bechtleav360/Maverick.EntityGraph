...
@Deprecated
public class ReplaceExternalIdentifiersServiceV1 {
    ...
    public ReplaceExternalIdentifiersServiceV1(QueryServices queryServices, EntityStore store, TransactionsStore trxStore, IdentifierFactory identifierFactory) {
    ...
    private Mono<StatementsBag> storeNewStatements(StatementsBag statements) {
        ...
        LocalIdentifier generatedIdentifier = identifierFactory.createRandomIdentifier(Local.Entities.NAMESPACE);
