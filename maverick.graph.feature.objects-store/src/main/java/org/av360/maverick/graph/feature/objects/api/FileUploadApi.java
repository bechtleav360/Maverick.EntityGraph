...
public class FileUploadApi extends AbstractController {


    protected final FileServices fileServices;


    public FileUploadApi(ValueServices values, EntityServices entities, SchemaServices schemaServices, FileServices fileServices) {
        this.fileServices = fileServices;
    }

    @GetMapping(value = "/content/{id:[\\w|\\d|\\-|\\_]+}")
    @ResponseStatus(HttpStatus.OK)
    public Mono<ResponseEntity<Flux<DataBuffer>>> read(@PathVariable String id) {
        return super.getAuthentication()
                ...
                .map(fileAccessResult -> {
                    ...
                    try {
                        String mediaType = Files.probeContentType(fileAccessResult.file());
    ...
    @ResponseStatus(HttpStatus.OK)
    public Flux<AnnotatedStatement> createWithFile(
