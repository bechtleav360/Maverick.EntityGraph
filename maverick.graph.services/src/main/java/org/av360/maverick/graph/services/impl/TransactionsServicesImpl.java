...
public class TransactionsServicesImpl implements TransactionsService {
    @Override
    public Flux<RdfTransaction> list(Integer limit, Integer offset, Authentication authentication) {
        return Flux.error(NotImplementedException::new);
    }

    @Override
    public Mono<RdfTransaction> find(String identifier, Authentication authentication) {
