...
public interface EntityServices {
     ...
     * @return Transaction with affected statements
     */
    Mono<Transaction> createEntity(StatementsBag triples, Map<String, String> parameters, Authentication authentication);

    Mono<Transaction> linkEntityTo(String entityIdentifier, String predicatePrefix, String predicateKey, StatementsBag linkedEntities, Authentication authentication);
}
