...
public class CreateDetails extends ApiTestsBase  {
    @Test
    public void createRecommendedRelation() {

        super.printStart("Create a value with a detail");
        ...
        RdfConsumer rc2 = super.getTestClient().createValue(sourceIdentifier, "sdo.teaches", "a certain skill");
